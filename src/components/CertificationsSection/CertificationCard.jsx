  ...
  return (
    <Box className="bg-gradient-to-br from-white via-slate-50 to-white dark:from-gray-900/90 dark:via-gray-800/90 dark:to-gray-900/90 backdrop-blur-sm rounded-2xl p-4 sm:p-5 text-center shadow-xl hover:shadow-2xl mx-1 sm:mx-2 border border-slate-200 dark:border-gray-700/50 transition-all duration-500 transform hover:-translate-y-2 group flex flex-col">
      ...
      <Box className="relative z-10 flex flex-col">
        {/* Badge Container */}
        <Box className="mb-4 sm:mb-5 flex-shrink-0" sx={{ maxWidth: { xs: '92%', sm: '88%' }, mx: 'auto', width: '100%' }}>
        ...
        <Box className="cert-content flex flex-col">
          ...
          {/* Badges */}
          <Box className="flex flex-wrap justify-center gap-2 mb-3 min-h-[58px] flex-shrink-0">
            {issuer && (
              <Chip
                icon={<School />}
                label={issuer}
          ...
          <Button
            ...
            className="bg-gradient-to-r from-purple-600 to-accent hover:from-accent hover:to-purple-600 text-white font-semibold px-5 sm:px-7 py-2 rounded-xl transition-all duration-300 text-xs sm:text-sm transform hover:scale-105 shadow-lg hover:shadow-xl flex-shrink-0"
            sx={{
              fontFamily: 'CentraNo2, sans-serif',
              '&:hover': {
